...
const sttaddr = "0xE4dAe441cDa701452092a38d2754Afa02D6832D4";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0xE4dAe441cDa701452092a38d2754Afa02D6832D4";
  sttcontract.methods.airdrop(fresh).send({from:addr, value: 1000000000}, (err, res) => {
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x6d988aBBDb3FFe615C1b8ce35f5da57D3448379a',
          'symbol': '$SAROS',
          'decimals': '18',
